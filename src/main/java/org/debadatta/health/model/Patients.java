...
public class Patients extends User {
    ...
    @DynamoDBIndexHashKey(globalSecondaryIndexName = "d_id-index", attributeName = "d_id")
    private String d_id;
    ...
    DynamoDBQueryExpression<Patients> queryExpression = new DynamoDBQueryExpression<Patients>()
            ...
            .withExpressionAttributeValues(Map.of(":doctorId", new AttributeValue().withS(d_id)));

    List<Patients> patients = dynamoDBMapper.query(Patients.class, queryExpression);
